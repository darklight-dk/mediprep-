...
const PREGUNTAS_MATEMATICAS = [
    ...
    {pregunta:"En una urna hay 5 rojas, 3 azules y 2 verdes. Probabilidad de sacar roja:",opciones:["5/10","1/2","1/5"],correcta:1,explicacion:"P = 5/10 = 1/2"},
    
    {pregunta:"Al lanzar dos dados, probabilidad de obtener suma 7:",opciones:["1/36","1/12","1/6"],correcta:2,explicacion:"6 combinaciones de 36 posibles = 6/36 = 1/6"},
    
    {pregunta:"Media aritmética de: 4, 8, 6, 10, 7",opciones:["7","6","8"],correcta:0,explicacion:"(4+8+6+10+7)/5 = 35/5 = 7"},
    
    {pregunta:"Mediana de: 3, 7, 5, 9, 6",opciones:["7","6","5"],correcta:1,explicacion:"Ordenando: 3,5,6,7,9. El central es 6"},
    
    {pregunta:"Moda de: 2, 5, 5, 8, 5, 9",opciones:["8","2","5"],correcta:2,explicacion:"Moda es el valor que más se repite: 5"},
